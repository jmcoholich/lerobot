...
def test_pi05_rtc_initialization():
    ...
    print("[OK] PI0.5 RTC initialization: Test passed")
...
def test_pi05_rtc_initialization_without_rtc_config():
    ...
    print("[OK] PI0.5 RTC initialization without RTC config: Test passed")
...
def test_pi05_rtc_inference_with_prev_chunk():
    ...
    print("[OK] PI0.5 RTC inference with prev_chunk: Test passed")
...
def test_pi05_rtc_inference_without_prev_chunk():
    ...
    print("[OK] PI0.5 RTC inference without prev_chunk: Test passed")
