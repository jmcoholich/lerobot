...
# Configuration
REPO_ID = "lerobot/plug_rev_from_rev_fwd_only_w_neg_tau_obs"
DATASET_NAME = "plug_rev_from_rev_fwd_only_w_neg_tau_obs"
...
def main():
    ...
    h5_files = sorted(ORIG_DATASET_PATH.glob("*fwd*.h5"))
