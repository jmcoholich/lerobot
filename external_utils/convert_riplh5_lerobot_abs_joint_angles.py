...
# Configuration
REPO_ID = "lerobot/eve_blocks_6x_abs_joint"
DATASET_NAME = "eve_blocks_6x_abs_joint"
...
def main():
    ...
    for h5_path in tqdm(h5_files):
        ...
        with h5py.File(h5_path, "r") as f:
            ...
            joint_angle_action[:-JOINT_ACTION_OFFSET] = f['joint_pos'][JOINT_ACTION_OFFSET:]
            joint_angle_action[-JOINT_ACTION_OFFSET:] = f['joint_pos'][-1]
